    ...
    <div id="top">
      ...
      <main>
        ...
        <section className="page-section" id="strategy">
          ...
          <div className="conclusion"><i>03</i><p><strong>底部总结：</strong>Everyday App 的逻辑是把外卖、杂货、零售、订阅和广告放在同一高频入口，先提高使用频次和跨品类消费，再提升广告变现、商户服务和履约效率；不同市场执行、客户获取成本、基础设施投入和复购会影响利润改善速度。</p></div>
        </section>
        ...
        <section className="page-section" id="guidance">
          ...
          <div className="analysis-layout">
            ...
            <AnalysisPanel title="FY26 财务预测反映现金流、韩国、MENA 和资本结构进展" items={profitabilityAnalysis} />
          </div>
